...
![Figure 1: Decode base64 string to binry file](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled.png)
...
![Figure 2: Decoded base64 string.](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%201.png)
...
![Untitled](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%202.png)
...
![Figure 4: The notepad process created by the injector.](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%203.png)
...
![Figure 5: The enterypoint of the shellcode.](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%204.png)
...
![Figure 6: 1FB977200D6 function](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%205.png)
...
![Figure 7: Function 000001FB9772000A](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%206.png)
...
![Figure 8: calling WSAStringToAddressA function](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%207.png)

Figure 8: calling WSAStringToAddressA function

![Figure 9: calling WSASocketW function](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%208.png)
...
![Figure 10: Breakpoint on connect function from ws2_32.dll function gets hit](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%209.png)
...
![Figure 11: sockaddr_in object in memory](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%2010.png)
...
![Figure 12: Port and ip printed](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%2011.png)
...
![Figure 13: The Socket connection code.](https://raw.githubusercontent.com/darksys0x/darksys0x.github.io/master/_posts/imgs/memoryAttack/Untitled%2012.png)
...
rule application {
   ...
   strings:
      ...
      $s2 = "[System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer((qwV kernel32.dll WaitForSingleObject), (j0Aiv @([IntPtr" ascii
      $s3 = "[System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer((qwV kernel32.dll WaitForSingleObject), (j0Aiv @([IntPtr" ascii
      $s4 = "$szJL = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer((qwV kernel32.dll CreateThread), (j0Aiv @([IntPt" ascii
      $s5 = "$oC = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer((qwV kernel32.dll VirtualAlloc), (j0Aiv @([IntPtr]" ascii
      $s6 = "$szJL = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer((qwV kernel32.dll CreateThread), (j0Aiv @([IntPt" ascii
      $s7 = "$zlVzg = ([AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.GlobalAssemblyCache -And $_.Location.Split('\\\\')[-1]." ascii
      $s8 = "uals('System.dll') }).GetType('Microsoft.Win32.UnsafeNativeMethods')" fullword ascii
      $s9 = "em.Runtime.InteropServices.HandleRef](New-Object System.Runtime.InteropServices.HandleRef((New-Object IntPtr), ($zlVzg.GetMethod" ascii
      $s10 = "ByQ1BAcHi7VJBUUiLUiCLQjxIAdBmgXgYCwIPhXIAAACLgIgAAABIhcB0Z0gB0FCLSBhEi0AgSQHQ41ZI/8lBizSISAHWTTHJSDHArEHByQ1BAcE44HXxTANMJAhFOdF" ascii
      $s11 = "[Byte[]]$bke7S = [System.Convert]::FromBase64String(\"/EiD5PDozAAAAEFRQVBSUVZIMdJlSItSYEiLUhhIi1IgSItyUEgPt0pKTTHJSDHArDxhfAIsIE" ascii
      $s12 = "Zu0FUSYnkTInxQbpMdyYH/9VMiepoAQEAAFlBuimAawD/1WoKQV5QUE0xyU0xwEj/wEiJwkj/wEiJwUG66g/f4P/VSInHahBBWEyJ4kiJ+UG6maV0Yf/VhcB0Ckn/znX" ascii
      $s13 = "l6JMAAABIg+wQSIniTTHJagRBWEiJ+UG6AtnIX//Vg/gAflVIg8QgXon2akBBWWgAEAAAQVhIifJIMclBulikU+X/1UiJw0mJx00xyUmJ8EiJ2kiJ+UG6AtnIX//Vg/g" ascii
      $s14 = "return $zlVzg.GetMethod('GetProcAddress', [Type[]]@([System.Runtime.InteropServices.HandleRef], [String])).Invoke($null, @([Syst" ascii
      $s15 = "return $zlVzg.GetMethod('GetProcAddress', [Type[]]@([System.Runtime.InteropServices.HandleRef], [String])).Invoke($null, @([Syst" ascii
      $s16 = "[System.Runtime.InteropServices.Marshal]::Copy($bke7S, 0, $oC, $bke7S.length)" fullword ascii
      $s17 = "$iGn.DefineMethod('Invoke', 'Public, HideBySig, NewSlot, Virtual', $ko05j, $mv8).SetImplementationFlags('Runtime, Managed')" fullword ascii
      $s18 = "$zlVzg = ([AppDomain]::CurrentDomain.GetAssemblies() | Where-Object { $_.GlobalAssemblyCache -And $_.Location.Split('\\\\')[-1]." ascii
      $s19 = "('GetModuleHandle')).Invoke($null, @($hkr0)))), $i1ja))" fullword ascii
      $s20 = "12FhEi0AkSQHQZkGLDEhEi0AcSQHQQYsEiEgB0EFYQVheWVpBWEFZQVpIg+wgQVL/4FhBWVpIixLpS////11JvndzMl8zMgAAQVZJieZIgeygAQAASYnlSbwCAAA1rBB" ascii
   condition:
...
rule powershell {
   ...
   strings:
      ...
      $x2 = "l.exe'}else{$b='powershell.exe'};$s=New-Object System.Diagnostics.ProcessStartInfo;$s.FileName=$b;$s.Arguments='-noni -nop -w hi" ascii
      $s3 = "=powershell.exe -nop -w hidden -noni -c if([IntPtr]::Size -eq 4){$b=$env:windir+'\\\\sysnative\\\\WindowsPowerShell\\\\v1.0\\\\p" ascii
      $s4 = "dden -c &([scriptblock]::create((New-Object System.IO.StreamReader(New-Object System.IO.Compression.GzipStream((New-Object Syste" ascii
      $s5 = "h4dVBWq/Lh/2z/ohp+e38B/06vRvUq95ZB8LAAA=''))),[System.IO.Compression.CompressionMode]::Decompress))).ReadToEnd()))';$s.UseShellE" ascii
      $s6 = "xecute=$false;$s.RedirectStandardOutput=$true;$s.WindowStyle='Hidden';$s.CreateNoWindow=$true;$p=[System.Diagnostics.Process]::S" ascii
      $s7 = "is4/3D8gl3KfuNqfzR5J7h1SihWq4waIO5djj+0NE9dh4TStDcGUr//xR11YnrdWTe1j7pCMr1tFRlHU9AipC9xngTkcFxvE1w3spkmWrGlziuM3F81JnDlrdAvWHpGB" ascii
      $s8 = "AQ6HtDlEsU+DhrR7I0nQqaRdW4Ikfz41NdkU/NFWg7U6gObJNjnYFtjVUMv2g+H/ill5HwXw8f4Vsy9rP9j9KRylBsv4m8WvF34J0V9NfOpgCoIW3KYEHZv5d/Iv6fHs" ascii
      $s9 = "aJB4WV2ANOBNEc3TmDsmxCwc9/k6DEdp4sqel6Isqze4JbO9XK1+55el47s8pjhCTT2mKE02FkofsYuyZt+JPYLu0HoFWhZNceyvBAHEHpMQ8bU4J6TB/YoZ/hZtK9h+" ascii
      $s10 = "/e97x4Y03abddqVFSMzjPs89M5d1HrsUJzH3cWtzn16dnoyc1Ik4vhaEqdTgarj14AgnJ7BR2xN773M3HL+UN5tOEjk4Xl1fq3maopge580eonKWoeieYJTxAvcXNw1Q" ascii
      $s11 = "6ssQIeQItV4PdMOFWAkOJ2czsTWBeKRosJNYrNHgCuxdhC/YtALA1ls4ssLiUKa9RJ6GvUu1uBoZkIfdApuxnY+nfbAJMefhFYMZ6tux1Lhn6bML7/5OEc+8ueMDnmey" ascii
      $s12 = "NIkUJ0OX7eM9wb8WNdx5O+okexkerXtn2oo1sRe64Q2IpVNrruHhJAh03NJ9mBcTzR9RafN+PO4PrE5fTju7YC3rma71lcJsKbLbx+/sgTKZgB5Wh+bDTpc9JfJn/lzd" ascii
      $s13 = "Vol/rgRSI5oKDajlS4kaiZcTdFStvxDpgQACPBUJALzPr05fna4rxjxIMn58zhkYnSwPYwQB8qMkwwfBGw6YZIAnhyZpAdPaOM2RsHqCl6tFj1eN76u3KlmQDBPp7QOs" ascii
      $s14 = "997fKNhLxZZ5c/OanQM4CLVEfcbu77Umw0mzwCHAemg51UXTTdJu2URGCWYaPM9+P0KUxohA74buXp1XmZDEZU3s2G2ggx77GmuzExi+uXhxJHBPgsKX5lYtXV8vIEq4" ascii
      $s15 = "SfSi8s7mIFRXiZNlDW6Uw6lzG5yFHIK8BifHGS635Jwmh2H9S7hGTih2nYxW5lZCCWPpTk3ijKa5C0WD1MfWBrnYIQyJBtfHHlIKC/uV2/qLOKgOIXASwNIj1AFWWP4W" ascii
      $s16 = "ZVRIIUJWdqFpIapHG4IiEDkc/i5xfDjqJd0P1HF85NX/EV9F5iNzGRAVAs+ig+paJKENzsYphSuEgXqg0H/y/uzyYHGoKSrLwFenY6kUlFG6dh+idxYjZInKAYOUQv7d" ascii
      $s17 = "6qNgpoMjdejrPnwVPXAVaSH5itRVh5YSaFiSfcvsm+3WQheviIL3lm7J/emTvyc/Wrvdn+3G8q0xkIPuB6/buuge9EOmvwh7w452mLtsbs4zDWvgR+vOTTtAU3ujTLXu" ascii
      $s18 = "Le0EeyvQKYtawz0m+gNudtAax6hTxE6E3Yp+/Es4ozVBhxybldgtBMXXyw3kdRBBvkMZcKzc36hpEaZPukqOiYdS2YVaZRAVlFH4OphjLfi6HhsoAoiOc+BfbQ2kR5V0" ascii
      $s19 = "wrQ3un+29U17KLa7gQLrOt4NN5YIT6s1eIy9vUGu9gaEa9qLAUYL3UeFL5uybM1jYt1vVUiklSrKIpe6E1gLx3q8M+83hlfM++JvtoHRJpFNTZa7BA5kJDvbjtiaJu9N" ascii
      $s20 = "m.IO.MemoryStream(,[System.Convert]::FromBase64String(''H4sIAJUtgV0CA7VWa2+bSBT9nEj9D6iyZFAcg1M3zUaKtICxjWtSE2z8WmtFYAwTBnBhiI27" ascii
   condition:
      uint16(0) == 0x703d and filesize < 7KB and
